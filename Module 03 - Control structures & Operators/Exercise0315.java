/*
Uma financeira contratou um programador para desenvolver um programa que calcula o
custo total de empréstimos para seus clientes, porém o contrato foi cancelado e você foi
chamado para concluir a programação do sistema.
O código-fonte abaixo (incompleto) foi repassado para você fazer seu trabalho:

O cliente também te informou que a taxa de juros da financeira depende da quantidade de
parcelas:
• 1 ou 2 parcelas: 1,99% ao mês
• 3 parcelas: 2,99% ao mês
• Outras quantidades de parcelas: 3,99% ao mês
Além disso, caso o valor do empréstimo seja maior ou igual a 100, uma tarifa fixa será
cobrada no valor de R$1,50.
*/
...
public class Exercise0315 {
  ...
  public static void main(String[] args) {
    ...
    // double tarifaFixa = valorEmprestimo < 100 ? 0 : 1.5; pode ser assim também.
